...
<body ng-app="myApp" ng-cloak layout="column">
	...
	<div class="md-toolbar-tools">
		...
		<md-button class="md-fab md-mini" aria-label="Favorite"> <md-icon
			md-svg-icon="img/icons/favorite.svg"></md-icon> </md-button>
	</div>
	</md-toolbar>
	<div flex layout="row">
		<md-sidenav flex="15" md-is-locked-open="true"
			class="md-whiteframe-z1"> <md-content>
		Navigation bar </md-content> </md-sidenav>
		<div layout="column" flex>
			<div class="box1">70</div>
			<div class="box2">fixed</div>
			<div class="box3">flex</div>
		</div>
	...
	<script
		src='${pageContext.request.contextPath}/js/angular-material.min.js'></script>
